...
#  define LIBFREENECT2_DEPRECATED_EXPORT LIBFREENECT2_EXPORT __attribute__ ((__deprecated__))
#  define LIBFREENECT2_DEPRECATED_NO_EXPORT LIBFREENECT2_NO_EXPORT __attribute__ ((__deprecated__))
#endif
