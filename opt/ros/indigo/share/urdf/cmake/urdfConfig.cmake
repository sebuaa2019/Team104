...
if("FALSE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-urdf-1.11.15)
  set(urdf_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-urdf-1.11.15/obj-x86_64-linux-gnu/devel)
...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
    endif()
