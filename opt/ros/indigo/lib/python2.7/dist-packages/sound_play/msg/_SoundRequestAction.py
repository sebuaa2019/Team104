...
class SoundRequestAction(genpy.Message):
  _md5sum = "469561382c553cd0eaf8d2a4c8cef442"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2b.pack(_x.action_goal.goal.sound_request.sound, _x.action_goal.goal.sound_request.command))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.sound_request.sound, _x.action_goal.goal.sound_request.command,) = _struct_2b.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
