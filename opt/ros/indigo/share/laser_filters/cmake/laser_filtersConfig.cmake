...
if("FALSE" STREQUAL "TRUE")
  set(laser_filters_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-laser-filters-1.8.5)
  set(laser_filters_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-laser-filters-1.8.5/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_filters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Jon Binney <jon.binney@gmail.com>' to fix it.")
    endif()
