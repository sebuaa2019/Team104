...
if("FALSE" STREQUAL "TRUE")
  set(rqt_image_view_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-rqt-image-view-0.4.9)
  set(rqt_image_view_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-rqt-image-view-0.4.9/obj-x86_64-linux-gnu/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rqt_image_view' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Aaron Blasdel <ablasdel@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rqt_image_view' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Dirk Thomas <dthomas@osrfoundation.org>, Aaron Blasdel <ablasdel@gmail.com>' to fix it.")
    endif()
