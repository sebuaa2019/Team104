...
(cl:defmethod cl:initialize-instance :after ((m <SetLinkProperties-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLinkProperties-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs-srv:<SetLinkProperties-request> is deprecated: use gazebo_msgs-srv:SetLinkProperties-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetLinkProperties-request>)))
  ...
  (cl:format cl:nil "string link_name~%~%geometry_msgs/Pose com~%~%~%bool gravity_mode~%float64 mass~%float64 ixx~%float64 ixy~%float64 ixz~%float64 iyy~%float64 iyz~%float64 izz~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetLinkProperties-request)))
  "Returns full string definition for message of type 'SetLinkProperties-request"
  (cl:format cl:nil "string link_name~%~%geometry_msgs/Pose com~%~%~%bool gravity_mode~%float64 mass~%float64 ixx~%float64 ixy~%float64 ixz~%float64 iyy~%float64 iyz~%float64 izz~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetLinkProperties-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLinkProperties-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_msgs-srv:<SetLinkProperties-response> is deprecated: use gazebo_msgs-srv:SetLinkProperties-response instead.")))
