...
(cl:defmethod cl:initialize-instance :after ((m <AveragingFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AveragingFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name actionlib_tutorials-msg:<AveragingFeedback> is deprecated: use actionlib_tutorials-msg:AveragingFeedback instead.")))
