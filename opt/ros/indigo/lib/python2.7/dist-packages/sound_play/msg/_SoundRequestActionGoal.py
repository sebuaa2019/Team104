...
class SoundRequestActionGoal(genpy.Message):
  _md5sum = "263b69ef77b0c5355d0375d85def66da"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2b.pack(_x.goal.sound_request.sound, _x.goal.sound_request.command))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.sound_request.sound, _x.goal.sound_request.command,) = _struct_2b.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
