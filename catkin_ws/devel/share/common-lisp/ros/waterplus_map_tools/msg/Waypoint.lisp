...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waterplus_map_tools-msg:<Waypoint> is deprecated: use waterplus_map_tools-msg:Waypoint instead.")))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waterplus_map_tools-msg:frame_id-val is deprecated.  Use waterplus_map_tools-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waterplus_map_tools-msg:name-val is deprecated.  Use waterplus_map_tools-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waterplus_map_tools-msg:pose-val is deprecated.  Use waterplus_map_tools-msg:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Waypoint>)))
  ...
  "b5abd84eafa003e99e40f2565ee73135")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Waypoint)))
  "Returns md5sum for a message object of type 'Waypoint"
  "b5abd84eafa003e99e40f2565ee73135")
