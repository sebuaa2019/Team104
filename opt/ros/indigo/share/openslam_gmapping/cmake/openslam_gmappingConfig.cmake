...
if("FALSE" STREQUAL "TRUE")
  set(openslam_gmapping_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-openslam-gmapping-0.1.1)
  set(openslam_gmapping_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-openslam-gmapping-0.1.1/obj-x86_64-linux-gnu/devel)
  ...
  set(openslam_gmapping_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openslam_gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
