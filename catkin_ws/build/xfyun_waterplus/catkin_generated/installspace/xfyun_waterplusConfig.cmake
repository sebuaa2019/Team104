...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xfyun_waterplus' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/javiera/catkin_ws/install/${idir}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
    endif()
