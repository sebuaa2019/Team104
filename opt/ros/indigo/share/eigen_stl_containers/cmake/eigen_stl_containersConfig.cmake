...
if("FALSE" STREQUAL "TRUE")
  set(eigen_stl_containers_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-eigen-stl-containers-0.1.8)
  set(eigen_stl_containers_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-eigen-stl-containers-0.1.8/obj-x86_64-linux-gnu/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'eigen_stl_containers' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'eigen_stl_containers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
    endif()
