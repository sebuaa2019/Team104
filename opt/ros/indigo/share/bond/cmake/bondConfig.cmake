...
if("FALSE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-bond-1.7.20)
  set(bond_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-bond-1.7.20/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
