...
if("FALSE" STREQUAL "TRUE")
  set(collada_urdf_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-collada-urdf-1.11.14)
  set(collada_urdf_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-collada-urdf-1.11.14/obj-x86_64-linux-gnu/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'collada_urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Chris Lalancette <clalancette@osrfoundation.org>, Shane Loretz <sloretz@osrfoundation.org>' to fix it.")
    endif()
