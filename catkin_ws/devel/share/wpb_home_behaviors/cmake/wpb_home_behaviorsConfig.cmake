...
if("TRUE" STREQUAL "TRUE")
  set(wpb_home_behaviors_SOURCE_PREFIX /home/javiera/catkin_ws/src/wpb_home/wpb_home_behaviors)
  set(wpb_home_behaviors_DEVEL_PREFIX /home/javiera/catkin_ws/devel)
  ...
  set(wpb_home_behaviors_INSTALL_PREFIX /home/javiera/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wpb_home_behaviors' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'wpb_home_behaviors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/javiera/catkin_ws/src/wpb_home/wpb_home_behaviors/${idir}'.  Ask the maintainer 'Zhang Wanjie <zhangwanjie@6-robot.com>' to fix it.")
    endif()
...
set(wpb_home_behaviors_EXPORTED_TARGETS "wpb_home_behaviors_generate_messages_cpp;wpb_home_behaviors_generate_messages_lisp;wpb_home_behaviors_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${wpb_home_behaviors_dep}_FOUND)
      find_package(${wpb_home_behaviors_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${wpb_home_behaviors_dep} REQUIRED ${depend_list})
  endif()
