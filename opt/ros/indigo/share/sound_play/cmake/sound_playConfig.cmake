...
if("FALSE" STREQUAL "TRUE")
  set(sound_play_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-sound-play-0.2.13)
  set(sound_play_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-sound-play-0.2.13/obj-x86_64-linux-gnu/devel)
  ...
  set(sound_play_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
